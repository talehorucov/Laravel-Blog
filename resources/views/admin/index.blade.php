                    ...
                    <div class="panel-footer bg-extralight">
                        <ul class="earning-box">
                            <li>
                                <div class="er-row">
                                    <div class="er-pic"><img
                                            src="{{ asset('backend/plugins/images/users/genu.jpg') }}" alt="varun"
                                            width="60" class="img-circle"></div>
                                    <div class="er-text">
                                        <h3>Andrew Simon</h3><span class="text-muted">10-11-2016</span>
                                    </div>
                            ...
                            <li>
                                <div class="er-row">
                                    <div class="er-pic"><img
                                            src="{{ asset('backend/plugins/images/users/govinda.jpg') }}" alt="varun"
                                            width="60" class="img-circle"></div>
                                    <div class="er-text">
                                        <h3>Daniel Kristeen</h3><span class="text-muted">10-11-2016</span>
                                    </div>
                            ...
                            <li>
                                <div class="er-row">
                                    <div class="er-pic"><img
                                            src="{{ asset('backend/plugins/images/users/pawandeep.jpg') }}"
                                            alt="varun" width="60" class="img-circle"></div>
                                    <div class="er-text">
                                        <h3>Chris gyle</h3><span class="text-muted">10-11-2016</span>
                                    </div>
                    ...
                    <div class="comment-center p-t-10">
                        <div class="comment-body">
                            <div class="user-img"> <img
                                    src="{{ asset('backend/plugins/images/users/pawandeep.jpg') }}" alt="user"
                                    class="img-circle"></div>
                            <div class="mail-contnet">
                                <h5>Pavan kumar</h5><span class="time">10:20 AM 20 may 2016</span>
                                <span class="label label-rouded label-info">PENDING</span>
                                <br /><span class="mail-desc">Donec ac condimentum massa. Etiam
                                    pellentesque pretium lacus. Phasellus ultricies dictum suscipit. Aenean
                                    commodo dui pellentesque molestie feugiat. Aenean commodo dui pellentesque
                                    molestie feugiat</span> <a href="javacript:void(0)"
                        ...
                        <div class="comment-body">
                            <div class="user-img"> <img
                                    src="{{ asset('backend/plugins/images/users/sonu.jpg') }}" alt="user"
                                    class="img-circle"> </div>
                            <div class="mail-contnet">
                                ...
                                <br /><span class="mail-desc">Donec ac condimentum massa. Etiam
                                    pellentesque pretium lacus. Phasellus ultricies dictum suscipit. Aenean
                                    commodo dui pellentesque molestie feugiat. Aenean commodo dui pellentesque
                                    molestie feugiat</span>
                            </div>
                        </div>
                        <div class="comment-body b-none">
                            <div class="user-img"> <img
                                    src="{{ asset('backend/plugins/images/users/arijit.jpg') }}" alt="user"
                                    class="img-circle"> </div>
                            <div class="mail-contnet">
                ...
                <div class="panel">
                    <div class="p-20">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <a href="javascript:void(0)" class="pull-right btn btn-rounded btn-success m-t-15"
                    ...
                    <div class="panel-footer">
                        <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="{{ asset('backend/plugins/images/users/1.jpg') }}" alt="user img"
                                            data-toggle="tooltip" data-placement="top" title="Steave" /></li>
                                    <li><img src="{{ asset('backend/plugins/images/users/2.jpg') }}" alt="user img"
                                            data-toggle="tooltip" data-placement="top" title="Jessica" /></li>
                                    <li><img src="{{ asset('backend/plugins/images/users/3.jpg') }}" alt="user img"
                                            data-toggle="tooltip" data-placement="top" title="Priyanka" /></li>
                                    <li><img src="{{ asset('backend/plugins/images/users/4.jpg') }}" alt="user img"
                            ...
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="{{ asset('backend/plugins/images/users/3.jpg') }}" alt="user ing"
                                            data-toggle="tooltip" data-placement="top" title="Priyanka" /></li>
                                    <li><img src="{{ asset('backend/plugins/images/users/4.jpg') }}" alt="user img"
                                            data-toggle="tooltip" data-placement="top" title="Selina" /></li>
                                </ul>
                            ...
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="{{ asset('backend/plugins/images/users/1.jpg') }}" alt="user img"
                                            data-toggle="tooltip" data-placement="top" title="Assign to Steave" /></li>
                                    <li><img src="{{ asset('backend/plugins/images/users/2.jpg') }}" alt="user img"
                                            data-toggle="tooltip" data-placement="top" title="Assign to Jessica" /></li>
                                    <li><img src="{{ asset('backend/plugins/images/users/4.jpg') }}" alt="user img"
                                            data-toggle="tooltip" data-placement="top" title="Assign to Selina" /></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                                ...
                                <ul class="chatonline">
                                    <li>
                                        ...
                                        <a href="javascript:void(0)"><img
                                                src="{{ asset('backend/plugins/images/users/varun.jpg') }}"
                                                alt="user-img" class="img-circle"> <span>Varun Dhavan
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)"><img
                                                src="{{ asset('backend/plugins/images/users/genu.jpg') }}"
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)"><img
                                                src="{{ asset('backend/plugins/images/users/ritesh.jpg') }}"
                                                alt="user-img" class="img-circle"> <span>Ritesh Deshmukh
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)"><img
                                                src="{{ asset('backend/plugins/images/users/arijit.jpg') }}"
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)"><img
                                                src="{{ asset('backend/plugins/images/users/govinda.jpg') }}"
                                                alt="user-img" class="img-circle"> <span>Govinda Star
                                                <small class="text-success">online</small></span></a>
                                    </li>
                                    <li>
                                        <div class="call-chat">
                                        ...
                                        <a href="javascript:void(0)"><img
                                                src="{{ asset('backend/plugins/images/users/hritik.jpg') }}"
                    ...
                    <div class="panel-body">
                        <div class="steamline">
                            <div class="sl-item">
                                ...
                                <div class="sl-right">
                                    <div><a href="#">Tohnathan Doe</a> <span class="sl-date">5 minutes
                                            ago</span></div>
                            ...
                            <div class="sl-item">
                                ...
                                <div class="sl-right">
                                    <div><a href="#">Hritik Roshan</a> <span class="sl-date">5 minutes
                                            ago</span></div>
                                    ...
                                    <div class="row inline-photos">
                                        <div class="col-xs-4"><img class="img-responsive" alt="user"
                                                src="{{ asset('backend/plugins/images/small/vd1.jpg') }}">
                                        </div>
                                        <div class="col-xs-4"><img class="img-responsive" alt="user"
                                                src="{{ asset('backend/plugins/images/small/vd2.jpg') }}">
                                        </div>
                                        <div class="col-xs-4"><img class="img-responsive" alt="user"
                                                src="{{ asset('backend/plugins/images/small/vd3.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sl-item">
                                <div class="sl-left"> <img class="img-circle" alt="user"
                                        src="{{ asset('backend/plugins/images/users/sonu.jpg') }}"> </div>
                                <div class="sl-right">
                                    <div><a href="#">Gohn Doe</a> <span class="sl-date">5 minutes
                                            ago</span></div>
                            ...
                            <div class="sl-item">
                                <div class="sl-left"> <img class="img-circle" alt="user"
                                        src="{{ asset('backend/plugins/images/users/ritesh.jpg') }}"> </div>
                                <div class="sl-right">
                                    <div><a href="#">Varun Dhavan</a> <span class="sl-date">5 minutes
                                            ago</span></div>
                                    <div class="desc">Contrary to popular belief</div>
                                </div>
                            </div>
                            <div class="sl-item">
                                <div class="sl-left"> <img class="img-circle" alt="user"
                                        src="{{ asset('backend/plugins/images/users/govinda.jpg') }}"> </div>
                                <div class="sl-right">
                                    <div><a href="#">Tiger Sroff</a> <span class="sl-date">5 minutes
                                            ago</span></div>
                                    <div class="desc">The generated lorem ipsum
                                        <br><a href="javascript:void(0)"
                                            class="btn m-t-10 m-r-5 btn-rounded btn-outline btn-success">Apporve</a>
                                        <a href="javascript:void(0)"
                                            class="btn m-t-10 btn-rounded btn-outline btn-danger">Refuse</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                                    <li>
                                        <div class="chat-image"> <img alt="male"
                                                src="{{ asset('backend/plugins/images/users/sonu.jpg') }}">
                                        </div>
                                        <div class="chat-body">
                                            <div class="chat-text">
                                                <h4>Sonu Nigam</h4>
                                                <p> Hi, All! </p> <b>10.00 am</b>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="odd">
                                    ...
                                    <li>
                                        ...
                                        <div class="chat-body">
                                            <div class="chat-text">
                                                <h4>Ritesh</h4>
                                                <p> Hi, Sonu and Genelia, </p> <b>10.05 am</b>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="odd">
            ...
            <div class="slimscrollright">
                ...
                <div class="r-panel-body">
                    ...
                    <ul class="m-t-20 chatonline">
                        ...
                        <li>
                            <a href="javascript:void(0)"><img
                                    src="{{ asset('backend/plugins/images/users/varun.jpg') }}" alt="user-img"
                                    class="img-circle"> <span>Varun Dhavan <small
                                        class="text-success">online</small></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><img
                                    src="{{ asset('backend/plugins/images/users/genu.jpg') }}" alt="user-img"
                                    class="img-circle"> <span>Genelia Deshmukh <small
                                        class="text-warning">Away</small></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><img
                                    src="{{ asset('backend/plugins/images/users/ritesh.jpg') }}" alt="user-img"
                                    class="img-circle"> <span>Ritesh Deshmukh <small
                                        class="text-danger">Busy</small></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><img
                                    src="{{ asset('backend/plugins/images/users/arijit.jpg') }}" alt="user-img"
                                    class="img-circle"> <span>Arijit Sinh <small
                                        class="text-muted">Offline</small></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><img
                                    src="{{ asset('backend/plugins/images/users/govinda.jpg') }}" alt="user-img"
                                    class="img-circle"> <span>Govinda Star <small
                                        class="text-success">online</small></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><img
                                    src="{{ asset('backend/plugins/images/users/hritik.jpg') }}" alt="user-img"
                                    class="img-circle"> <span>John Abraham<small
                                        class="text-success">online</small></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><img
                                    src="{{ asset('backend/plugins/images/users/john.jpg') }}" alt="user-img"
                                    class="img-circle"> <span>Hritik Roshan<small
                                        class="text-success">online</small></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><img
                                    src="{{ asset('backend/plugins/images/users/pawandeep.jpg') }}" alt="user-img"
